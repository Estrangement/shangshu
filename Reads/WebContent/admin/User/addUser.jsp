...
<article class="page-container">
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i>
         ...
         <span class="c-gray en">&gt;</span> <font color="cornflowerblue">用户录入</font>
	...
	<form class="form form-horizontal" id="form-admin-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  id="tum" name="uname">
				<span id="span_B"></span>
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  id="tum" name="age">
				<span id="span_B"></span>
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  id="tum" name="tel">
				<span id="span_B"></span>
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  id="tum" name="username">
				<span id="span_B"></span>
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"   name="pwd">
				<span id="span_B"></span>
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  id="tum" name="email">
				<span id="span_B"></span>
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  id="tum" name="address">
				<span id="span_B"></span>
			</div>
		</div>
		<div class="row cl">
			...
			<c:forEach items="${libc}" var="u" >
					<div class="radio-box">
					<input name="rid" type="checkbox" id="sex-1" value="${u.rid }">
