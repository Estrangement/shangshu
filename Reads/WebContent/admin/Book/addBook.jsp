...
<article class="page-container">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2" id="guan"><span class="c-red" id="guan">*</span>书籍封面：</label>
			<div class="formControls col-xs-8 col-sm-9">
			<c:if test="${imagesPath !=null}"><img  src="<%=basePath%>${imagesPath }" width="100px" height="80px;"></c:if>
			<form action="<%=basePath%>/book/shangchuan" method="post" enctype="multipart/form-data">
				<div class="uploader-thum-container" id="tu">
	...
	<form  class="form form-horizontal" id="form-admin-add" >
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="articletitle" name="bname">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="articletitle" name="price">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">作者：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="articletitle" name="author">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">出版社：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="articletitle" name="press">
			</div>
		</div>
		<div class="row cl">
