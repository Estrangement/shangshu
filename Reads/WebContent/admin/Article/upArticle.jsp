...
<article class="page-container">
		<div class="row cl">
			...
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red" id="guan">*</span>文章关键图：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<c:if test="${biao==0 }"><img  src="<%=basePath%>${bb.photo }" width="100px" height="80px;"></c:if>
			<c:if test="${imagesPath !=null}"><img  src="<%=basePath%>${imagesPath }" width="100px" height="80px;"></c:if>
			<form action="<%=basePath%>/article/upload" method="post" enctype="multipart/form-data">
				<div class="uploader-thum-container">
					<input type="hidden" value="${bb.aid }" name="id">
	...
	<form  class="form form-horizontal" id="form-admin-add" >
		<input type="hidden" value="${imagesPath }" name="photo">
		<input type="hidden" value="${bb.aid }" name="aid">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${bb.brief }" placeholder="" id="articletitle" name="brief">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">文章来源：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${bb.source }" placeholder="" id="articletitle" name="source">
			</div>
		</div>
		<div class="row cl">
    		...
    		submitHandler:function(form){
    			$(form).ajaxSubmit({
    				...
    				success: function(data){
    					...
    					window.location.href = '<%=basePath%>/article/findAllByPage';
    					}
    				}
    			});
    		}
